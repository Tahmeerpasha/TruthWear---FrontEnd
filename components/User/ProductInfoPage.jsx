...
const ProductInfoPage = ({ id }) => {
    ...
    return (
        <div className=" pt-20 w-full h-screen dark:bg-gray-800 py-8">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row -mx-4">
                    ...
                    <div className="md:flex-1 px-4">
                        ...
                        {user?.firstName !== '' && <div className="flex -mx-2 mb-4">
                            <div className="w-1/2 px-2">
                                <AddToCartButton product={product} />
                            </div>
                            <div className="w-1/2 px-2">
                                <Button className="w-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white  font-bold hover:bg-gray-300 dark:hover:bg-gray-600">Add to Wishlist</Button>
                            </div>
                        </div>
                        }
                    </div>
